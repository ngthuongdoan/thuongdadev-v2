...
description: "A production-minded personal portfolio built to present work with
  stronger technical context: Astro SSR, structured content, metadata strategy,
  and a GitHub-backed CMS workflow."
category: opensource
status: live
...
metrics:
  ...
  - SEO foundation includes canonical URLs, Open Graph data, Twitter cards, and
    JSON-LD
  - GitHub OAuth flow keeps the content publishing surface behind an
    approved-user gate
highlights:
  - Reframed the site from a visual template into a sharper senior-engineering
    portfolio
  - Built content-driven project pages that can show stack, delivery role, and
    proof points
  - Kept the site easy to extend through markdown collections and a simple
    publishing workflow
order: 1
---
## Problem
