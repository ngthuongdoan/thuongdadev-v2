                ...
                {isOpen &&
                    <>
                        ...
                        >
                            ...
                            <nav className="fixed bottom-20 sm:bottom-32 left-4 sm:left-8 flex flex-col items-start justify-center gap-4" aria-label="Mobile navigation">
